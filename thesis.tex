...
\input{CMS_experiment/CMS_experiment}
...
\newpage
  ...
  \node[inner sep=12pt, below of=title1, text width=10cm, align=center, outer sep=12pt] (title) {-- \textup{Srpska narodna izreka} --};
  \node[anchor=north] at (title.south){\pgfornament[width=5cm]{87}};
  \node[anchor=south] at (chapter.north){\pgfornament[width=4cm,symmetry=h]{58}};
  \end{tikzpicture} 
...
\input{Analysis_strategy/Analysis_strategy}
\input{Control_Regions/Control_Regions}
% body of thesis comes here

\newpage
\include{FIt_structure/Fit_structure}
\newpage
